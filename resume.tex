...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Bachelor of Science in Mechanical Engineering, Minor: Computer Science / Math ;  GPA: 3.89}{Aug. 2011 -- April. 2018}
      \resumeItemListStart
	      \resumeItem{Relevant Classes}
		     {Deep Learning, Robotics, Controls, Algorithm Design \& Analysis, Advanced Programming Concepts, Data Structures, Discrete Data, Dynamic Modeling, Mechatronics, Mechanical Design}
      \resumeItemListEnd 
